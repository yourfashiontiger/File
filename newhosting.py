...
@app.route('/')
def home():
    return "I'm file hosting bot powered by @DlVYA"
...
# --- Configuration ---
TOKEN = '8295419328:AAGDBhWG53Iw4zJWnavqKuElFLzCKxYeX6I' # Replace with your actual token
OWNER_ID = 5619325814 # Replace with your Owner ID
ADMIN_ID = 5851567058 # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = '@DlVYA' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = '@cuncept' # Replace with your update channel link
